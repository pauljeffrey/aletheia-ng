        ...
        <section className="py-16 bg-bg-dark">
            <div className="container mx-auto px-4 max-w-5xl">
                <div className="text-center mb-16">
                    <h2 className="text-4xl font-bold gradient-text mb-4">About Aletheia AI</h2>
                ...
                <div className="mb-16">
                    <h3 className="text-2xl font-semibold mb-6 text-text-white border-b border-primary-green/30 pb-2">Our Story</h3>
                ...
                <div className="mb-16">
                    <h3 className="text-2xl font-semibold mb-6 text-text-white border-b border-primary-green/30 pb-2">Our Mission</h3>
                    <p className="text-text-light mb-4">
                ...
                <div className="mb-16">
                    <h3 className="text-2xl font-semibold mb-6 text-text-white border-b border-primary-green/30 pb-2">Our Vision</h3>
                    <p className="text-text-light mb-4">
                ...
                <div className="mb-16">
                    <h3 className="text-2xl font-semibold mb-6 text-text-white border-b border-primary-green/30 pb-2">Our Values</h3>
                    <div className="grid md:grid-cols-2 gap-8">
                        <div>
                            <h4 className="text-xl font-medium text-primary-green mb-2">Inclusivity</h4>
                            <p className="text-text-light">We aim to design AI systems that work for diverse populations, languages, and contexts, ensuring no community is left behind.</p>
                        </div>
                        <div>
                            <h4 className="text-xl font-medium text-primary-green mb-2">Innovation</h4>
                            <p className="text-text-light">We push the boundaries of what's possible, developing novel approaches to solve complex challenges.</p>
                        </div>
                        <div>
                            <h4 className="text-xl font-medium text-primary-green mb-2">Integrity</h4>
                            <p className="text-text-light">We uphold the highest ethical standards in our research and development, prioritizing transparency and accountability.</p>
                        </div>
                        <div>
                            <h4 className="text-xl font-medium text-primary-green mb-2">Impact</h4>
                            <p className="text-text-light">We measure our success by the tangible difference our solutions make in people's lives and communities.</p>
                        </div>
                    </div>
                </div>
                
                <div className="mb-16">
                    <h3 className="text-2xl font-semibold mb-6 text-text-white border-b border-primary-green/30 pb-2">Our Approach</h3>
                    <p className="text-text-light mb-4">
                ...
                <div className="mb-16">
                    <h3 className="text-2xl font-semibold mb-6 text-text-white border-b border-primary-green/30 pb-2">Our Founder</h3>
                    <div className="flex flex-col md:flex-row items-center md:items-start gap-8">
                        <div className="w-48 h-48 bg-bg-card rounded-full flex-shrink-0 border border-primary-green/30 flex items-center justify-center">
                        <img src="/jeffrey.jpg" alt="Dr. Otoibhi Jeffrey" className="w-full h-full rounded-full object-cover" />
                        </div>
                        <div>
                            <h4 className="text-xl font-medium text-primary-green mb-2">Dr. Jeffrey Otoibhi</h4>
                            <p className="text-text-light mb-4">
                            ...
                            <p className="text-text-light">
                                <a href="http://www.aletheia.com.ng/jeffreyotoibhi" className="text-primary-green hover:text-cyan font-medium">
                ...
                <div className="mb-16">
                    <h3 className="text-2xl font-semibold mb-6 text-text-white border-b border-primary-green/30 pb-2">Our Projects</h3>
                    <div className="grid md:grid-cols-2 gap-8">
                        <div className="bg-gradient-card p-6 rounded-lg shadow-md border border-primary-green/30">
                            <h4 className="text-xl font-medium text-primary-green mb-2">SabiYarn-125M</h4>
                            <p className="text-text-light">
                        ...
                        <div className="bg-gradient-card p-6 rounded-lg shadow-md border border-primary-green/30">
                            <h4 className="text-xl font-medium text-primary-green mb-2">MedVault AI</h4>
                            <p className="text-text-light">
                        ...
                        <div className="bg-gradient-card p-6 rounded-lg shadow-md border border-primary-green/30">
                            <h4 className="text-xl font-medium text-primary-green mb-2">Ottobiz</h4>
                            <p className="text-text-light">
                ...
                <div>
                    <h3 className="text-2xl font-semibold mb-6 text-text-white border-b border-primary-green/30 pb-2">Join Our Mission</h3>
                    <p className="text-text-light mb-4">
                    ...
                    <div className="text-center">
                        <a href="/contact" className="inline-block bg-gradient-hover text-white px-6 py-3 rounded-md font-medium hover:shadow-glow transition-all">
                            Contact Us
                        </a>
                    </div>
                </div>
